<template>
  <div class="rainbow-nav" >
    <!-- navbar-nav -->
    <div class="nav-box">
      <img class="logo" src="../assets/logo.png" @click="$router.push({path:'/'})" alt="">
      <ul class="navbar-nav">
...
.rainbow-nav {
  ...
  .navbar-nav {
    ...
    .re-active{
      ...
      left: 0;
      transition: 0.2s;
      background-image: linear-gradient(90deg, #12c2e9 0%, #f3daff 64%, #fda0a0 100%);
    ...
    .active {
      ...
      .w-font{
        position: relative;
        background-image: linear-gradient(90deg, #12c2e9 0%, #bfffe9 64%, #fdd0d0 100%);
        -webkit-background-clip: text;
        -webkit-text-fill-color: transparent;
      }
      &:after {
